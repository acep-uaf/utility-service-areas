...
The goal of this project is to create a single geospatial layer containing the service area boundaries of every active electric utility in Alaska.

-   The State of Alaska [Division of Community and Regional Affairs](https://dcra-cdo-dcced.opendata.arcgis.com/search?q=rca) (DCRA) also provides service area layers for electric, water, sewer, and natural gas utilities certificated by the RCA. For more information, visit the DCRA open data portal at <https://dcra-cdo-dcced.opendata.arcgis.com/search?q=rca>
...
### You can explore the service areas on an [interactive map](/), and visit the [Alaska Energy Data Gateway](https://akenergygateway.alaska.edu/explore/communities/anchorage) to see the dataset in action.

# Download the data

Download the latest version of the GeoJSON file: <a href="/service-areas.geojson" target="_blank" download>Download now</a>

# GitHub repository

Access the GitHub repository here: <https://github.com/acep-aedg/aedg-utility-service-areas>
