...
welcome_message = `${button_code}<h3>Alaska electric utilities service area explorer</h3><br><br><br>This interactive map enables you to view Alaskan electric utility service areas.<br><br>Try browsing around the map and clicking on a utility service area `;
